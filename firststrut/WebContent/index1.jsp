...
<html>
<head>
<title>Spares Inventory Management</title>
...
<body>
	<div class="wrapper">
		<h1>Spares Inventory Management</h1>
		...
		<div class="content">
			<div id="form_wrapper" class="form_wrapper">
				...
				<%-- 
					<s:form action="product" validate="true" class="login active">
 --%>
				<h3>Login</h3>
				<div>
					<s:textfield name="username" key="label.id"></s:textfield>
					<span class="error">This is an error</span>
				</div>
				<div>
					<!-- 						<label>Password: </label> -->
					<a href="forgot_password.html" rel="forgot_password"
						class="forgot linkform">Forgot your password?</a>
 ...
 --%>
					<input type="submit" value="Login"></input> <a href="register.html"
 ...
 --%>
		...
		<a class="back"
			href="http://tympanus.net/codrops/2011/01/06/animated-form-switching/">slogan</a>
	</div>
