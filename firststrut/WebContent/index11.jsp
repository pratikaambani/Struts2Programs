...
<html>
    <head>
        <title>Global Clowd Exchange</title>
    ...
    <body>
		<div class="wrapper">
			<h1>Global Clowd Exchange</h1>
			<h2>An simplified solution to manage inventories and ...  </h2>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					<form class="register">
						...
						<div class="bottom">
							...
							<a href="menu.jsp" rel="login" class="linkform">You have an account already? Log in here</a>
							<div class="clear"></div>
						</div>
					</form>
					...
					<form class="forgot_password">
						...
						<div class="bottom">
							...
							<a href="menu.jsp" rel="login" class="linkform">Suddenly remebered? Log in here</a>
...
</html><%-- <%@ taglib uri="/struts-tags" prefix="s" %>
